...
cnx = mysql.connector.connect(user='root', password='YooJH@0319', host='localhost', database='starbucks_customized')
cursor = cnx.cursor()
...
print("Order_id customer_id shop_id custom_bread    custom_coffee")
for data in cursor:
